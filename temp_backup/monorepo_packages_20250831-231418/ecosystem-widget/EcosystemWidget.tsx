  ...
  if (isMinimized) {
    return (
      <button
        ...
        className={`fixed ${positionClasses[position]} z-50 p-2 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full shadow-lg hover:scale-110 transition-transform`}
      >
    ...
    >
      ...
      >
        <div className="relative">
          <div className="p-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full shadow-xl hover:shadow-2xl transition-all group-hover:scale-110">
            <Leaf className="w-5 h-5 text-white" />
          </div>
          {!hasInteracted && (
            <motion.div

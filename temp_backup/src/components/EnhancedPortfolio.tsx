...
// Animated counter
function AnimatedCounter({ end, duration = 2000, delay = 0, suffix = '' }) {
            ...
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="text-3xl font-bold text-white">
                  <AnimatedCounter end={stat.value} delay={600 + index * 100} suffix={stat.suffix} />
                </div>
                      ...
                      <div className="flex items-center space-x-4">
                        {product.stats.users && (
                          <div className="text-sm">
                            ...
                            <span className="text-white font-semibold">{product.stats.users.toLocaleString()}</span>
                          </div>
                        )}
                        {product.stats.growth && (
                          <div className="text-sm">
                            <span className="text-green-400 font-semibold">{product.stats.growth}</span>
                          </div>
                        )}
                        {product.stats.stars && (

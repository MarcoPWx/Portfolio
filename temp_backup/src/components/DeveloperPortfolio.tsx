          ...
          <div className="max-w-4xl w-full">
            ...
            <div className="bg-gray-900 rounded-lg p-6 border border-gray-800 mb-8">
              ...
              <div className="font-mono">
                ...
                <div className="text-green-400 mb-4">{terminalText}<span className="animate-pulse">_</span></div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xl text-gray-300 mb-6">
                  ...
                  developers' lives easier. Currently working on some cool stuff with 
                  pattern recognition, psychological gamification, and multi-agent AI systems.
                </p>
                <p className="text-gray-400 mb-8">
                  I believe in building things that are both technically interesting and 
                  actually useful. Check out my projects below to see what I've been working on.
                </p>
              </div>
              ...
              <div className="pt-8 border-t border-gray-800">
                ...
                <div className="flex flex-wrap gap-2">
                  {['WASM', 'Rust', 'Local LLMs', 'Vector Embeddings', 'Edge Computing'].map(tech => (
                    <span key={tech} className="px-3 py-1 bg-gray-900 text-gray-400 rounded-full text-sm">
                      {tech}
                    </span>
                  ))}
                </div>
            ...
            {currentProject && (
              ...
              >
                <div className="p-6 border-b border-gray-800">
                  <h3 className="text-2xl font-bold mb-4">{currentProject.title} - Technical Details</h3>
        ...
        <section className="min-h-screen pt-20 px-4 pb-16">
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-gray-400">
                Technologies I work with regularly. I love learning new things and picking 
        ...
        <section className="min-h-screen pt-20 px-4 pb-16">
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-gray-400">
                Experimental stuff and things I'm tinkering with. Not production ready, 
                but fun to explore!
              </p>
            </div>
        ...
        <section className="min-h-screen pt-20 px-4 pb-16 flex items-center">
          <div className="max-w-2xl mx-auto w-full">
            <div className="bg-gray-900 rounded-lg p-8 border border-gray-800">
              ...
              <p className="text-gray-400 mb-8">
                I'm always interested in working on cool projects or just chatting about tech. 

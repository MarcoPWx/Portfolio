...
import { 
  ...
  FileText, Briefcase, GraduationCap, Target
} from 'lucide-react';
          ...
          >
            ...
            <div className="text-center space-y-6">
              ...
              <div className="flex justify-center space-x-4">
                <a href="https://github.com" className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                  <Github className="w-5 h-5 text-gray-300" />
                </a>
                <a href="https://linkedin.com" className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                  <Linkedin className="w-5 h-5 text-gray-300" />
                </a>
                <a href="https://twitter.com" className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                  <Twitter className="w-5 h-5 text-gray-300" />
                </a>
                <a href="mailto:your@email.com" className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                innovative web applications and AI-powered solutions. My journey in tech has led 
                me to create the NatureQuest ecosystem - a suite of tools designed to empower 
                developers and learners alike.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed mt-4">
                When I'm not coding, you'll find me writing about technology, contributing to 
                open-source projects, or exploring the latest advancements in artificial intelligence. 
                I believe in building tools that make a difference and sharing knowledge with the 
                developer community.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['TypeScript', 'React', 'Next.js', 'Node.js', 'Python', 'Go', 'PostgreSQL', 
                  'MongoDB', 'AWS', 'Docker', 'Kubernetes', 'GraphQL', 'TensorFlow'].map((skill) => (

...
function LiveCodeExample({ title, files, defaultFile = 0 }) {
  ...
  const highlightCode = (code, language) => {
    if (language === 'typescript' || language === 'javascript') {
      return code
        .replace(/\b(const|let|var|function|class|interface|type|export|import|from|async|await|return|if|else|for|while|try|catch|throw|new|this|extends|implements)\b/g, '<span class="text-purple-400">$1</span>')
        .replace(/\b(string|number|boolean|void|any|null|undefined|true|false)\b/g, '<span class="text-blue-400">$1</span>')
        .replace(/('.*?'|\".*?\"|`.*?`)/g, '<span class="text-green-400">$1</span>')
        .replace(/(\/\/.*$)/gm, '<span class="text-gray-500">$1</span>')
        .replace(/\b(\d+)\b/g, '<span class="text-orange-400">$1</span>');
    } else if (language === 'python') {
      return code
        .replace(/\b(def|class|import|from|as|return|if|else|elif|for|while|try|except|with|async|await|lambda|yield)\b/g, '<span class="text-purple-400">$1</span>')
        .replace(/\b(str|int|float|bool|list|dict|tuple|set|None|True|False)\b/g, '<span class="text-blue-400">$1</span>')
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center space-y-8">
                ...
                <p className="text-lg text-gray-500 max-w-3xl mx-auto leading-relaxed">
                  Senior Full-Stack Engineer specializing in AI-powered applications,
                  distributed systems, and modern web architecture. Transforming complex
                ...
                <div className="flex justify-center gap-6 pt-8">
                  <a href="https://github.com/hmachuca" className="text-gray-600 hover:text-gray-400 transition-colors">
                    <Github className="w-6 h-6" />
                  </a>
                  <a href="https://linkedin.com/in/hmachuca" className="text-gray-600 hover:text-gray-400 transition-colors">
                    <Linkedin className="w-6 h-6" />
                  </a>
                  <a href="mailto:contact@hmachuca.dev" className="text-gray-600 hover:text-gray-400 transition-colors">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-400">End-to-end type safety with TypeScript and Zod validation</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-green-400 mt-1" />
                        <div>
                          ...
                          <div className="text-sm text-gray-400">Microservices with event-driven communication</div>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-400">WebSocket connections with automatic reconnection</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-green-400 mt-1" />
                        <div>
                          ...
                          <div className="text-sm text-gray-400">Smart routing between multiple LLM providers</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-8">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-green-600/10 to-teal-600/10 rounded-lg border border-green-600/20">
                  ...
                  <p className="text-sm text-gray-400">
                    Open to full-time opportunities, consulting engagements, and interesting collaborations.
                    Particularly interested in AI/ML, distributed systems, and developer tools.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="mb-8">
                    ...
                    <ul className="space-y-2 text-gray-300">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Architected and deployed 4 production SaaS products serving 10,000+ users</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <ChevronRight className="w-4 h-4 text-gray-600 mt-1" />
                        <span>Built multi-agent AI infrastructure reducing content processing costs by 70%</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <ChevronRight className="w-4 h-4 text-gray-600 mt-1" />
                        <span>Implemented real-time multiplayer system handling 1000+ concurrent connections</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="relative pl-8 border-l-2 border-gray-800">
                  ...
                  <div className="mb-8">
                    ...
                    <ul className="space-y-2 text-gray-300">
                      ...
                      <li className="flex items-start gap-2">
                        <ChevronRight className="w-4 h-4 text-gray-600 mt-1" />
                        <span>Reduced API response times by 60% through optimization and caching</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <ChevronRight className="w-4 h-4 text-gray-600 mt-1" />
                        <span>Mentored junior developers and established code review practices</span>
                      </li>
                    </ul>
                  </div>
                </div>

...
const products: Product[] = [
  {
    ...
    description: 'Personalized quiz experiences that adapt to your learning pace. Track progress, compete with friends, and master new topics through gamified learning.',
    icon: '🎓',
  ...
  },
  {
    ...
    description: 'Effortlessly track time across projects with intelligent categorization. Get insights into your productivity and optimize your workflow.',
    icon: '⏱️',
  ...
  },
  {
    ...
    description: 'One extension to rule them all. Connect to any AI provider and switch seamlessly between models without changing your workflow.',
    icon: '🔮',
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            A suite of powerful tools designed to enhance your productivity, 
            learning, and development workflow. Each product seamlessly integrates 

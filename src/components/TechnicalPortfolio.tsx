...
function CodeEditor({
  ...
  const highlightCode = (code: string) => {
    ...
    return code
      ...
      .replace(
        /\b(const|let|var|function|return|if|else|for|while|import|export|default|from)\b/g,
  ...
  return (
    <div className="min-h-screen bg-black text-white">
            ...
            <div className="max-w-5xl mx-auto">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {activeTab === 'terminal' && (
                    <Terminal commands={currentDemo.terminal} title="Terminal" />
                  )}
                  {activeTab === 'api' && (
                    <ApiResponse data={currentDemo.api.data} endpoint={currentDemo.api.endpoint} />
                  )}
                  {activeTab === 'schema' && <DatabaseSchema tables={currentDemo.schema} />}
                  {activeTab === 'metrics' && <MetricsDisplay metrics={currentDemo.metrics} />}
                </motion.div>
              </AnimatePresence>
            </div>
          </motion.div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Stay productive and manage your app</h2>
  ...
  payload: { x: 100, y: 200 }
      ...
      <section className="py-32 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-8">Start your project in seconds, not hours</p>

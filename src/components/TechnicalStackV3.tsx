...
export function TechnicalStackV3() {
  ...
  const allSkills: Skill[] = [
    ...
    },
    {
      ...
      projects: ['AI Assistant', 'Platform ML'],
    ...
    },
    {
      ...
      projects: ['QuizMentor', 'Platform', 'Portfolio'],
    ...
    },
    {
      ...
      description: 'Socket.io, real-time features, WebRTC, live collaboration',
      highlights: [
      ...
      projects: ['QuizMentor', 'PatientSky', 'Enterprise Platform'],
      tags: ['backend', 'realtime', 'communication'],
      trending: true,
      color: 'from-blue-500 to-cyan-500',
      relatedSkills: ['Socket.io', 'WebRTC', 'Node.js', 'Redis'],
      lastUsed: 'Currently using',
    },
    {
      id: 'redis',
      ...
      category: 'Backend',
      icon: <Database className="w-4 h-4" />,
      description: 'In-memory caching, pub/sub, session management, queues',
      highlights: [
      ...
      projects: ['QuizMentor', 'Enterprise Platform', 'Enterprise systems'],
      tags: ['backend', 'cache', 'database', 'performance'],
      trending: true,
      color: 'from-red-500 to-red-600',
      relatedSkills: ['Node.js', 'WebSockets', 'Bull'],
      lastUsed: 'Currently using',
    },
    ...
    // AI/ML
    {
      ...
      description: 'Agents, chains, memory, RAG systems',
      projects: ['Platform', 'AI Assistant'],
      tags: ['ai', 'llm', 'rag'],
      trending: true,
      color: 'from-purple-500 to-pink-500',
      relatedSkills: ['OpenAI', 'Vector DBs', 'Python'],
      lastUsed: 'Currently using',
    },
    {
      id: 'openai',
    ...
    },
    {
      ...
      description: 'Local LLM deployment, model management, inference optimization',
      projects: ['Enterprise Platform', 'Local AI'],
      tags: ['local-llm', 'privacy-first', 'ai'],
      trending: true,
      color: 'from-slate-600 to-slate-800',
      relatedSkills: ['Local LLMs', 'Python', 'MCP'],
      lastUsed: 'Currently using',
    },
    {
      id: 'rag',
      ...
      category: 'AI/ML',
      icon: <Database className="w-4 h-4" />,
      description: 'Context-aware AI with vector search, chunking, and embeddings',
      projects: ['Platform', 'Documentation System'],
      tags: ['rag', 'context-engineering', 'ai'],
      trending: true,
      color: 'from-indigo-500 to-purple-600',
      relatedSkills: ['Vector DBs', 'LangChain', 'Embeddings'],
      lastUsed: 'Currently using',
    },
    {
      id: 'mcp',
      ...
      category: 'AI/ML',
      icon: <Network className="w-4 h-4" />,
      description: 'Standardized context sharing between AI models and tools',
      projects: ['Documentation System', 'Enterprise Platform'],
      tags: ['mcp', 'mcp-server', 'context-engineering'],
      trending: true,
      color: 'from-cyan-500 to-blue-600',
      relatedSkills: ['RAG', 'Ollama', 'Local LLMs'],
      lastUsed: 'Currently using',
    },
    {
      ...
      description: 'Few-shot learning, chain-of-thought, system prompts, context optimization',
      projects: ['All AI projects'],
      tags: ['prompt-engineering', 'context-engineering', 'ai'],
      color: 'from-yellow-500 to-orange-500',
      relatedSkills: ['OpenAI', 'Anthropic', 'LangChain'],
      lastUsed: 'Currently using',
    },
    {
      id: 'anthropic',
      ...
      category: 'AI/ML',
      icon: <Sparkles className="w-4 h-4" />,
      description: 'Claude 3 Opus/Sonnet, MCP protocol, 200K context windows',
      highlights: [
      ...
      projects: ['GenericMCP', 'Repoman', 'AI projects'],
      tags: ['ai', 'llm', 'claude', 'mcp'],
      trending: true,
      color: 'from-orange-500 to-red-500',
      relatedSkills: ['OpenAI', 'Prompt Engineering', 'LangChain', 'MCP'],
      lastUsed: 'Currently using',
    },
    {
      id: 'gemini',
      ...
      category: 'AI/ML',
      icon: <Sparkles className="w-4 h-4" />,
      description: 'Gemini Pro/Ultra, multimodal AI, 1M+ context windows',
      highlights: [
      ...
      projects: ['AI research', 'Documentation System'],
      tags: ['ai', 'llm', 'gemini', 'multimodal'],
      trending: true,
      color: 'from-blue-500 to-green-500',
      relatedSkills: ['OpenAI', 'Anthropic', 'Vertex AI'],
      lastUsed: 'Currently using',
    },
    {
      id: 'embeddings',
      ...
      description: 'Semantic search, similarity matching, vector representations',
      projects: ['Platform', 'AI Assistant'],
      tags: ['embeddings', 'vectors', 'search'],
      color: 'from-teal-500 to-cyan-600',
      relatedSkills: ['Vector DBs', 'RAG', 'OpenAI'],
      lastUsed: 'Currently using',
    },
    {
      id: 'autogen',
      ...
      description: 'Multi-agent orchestration, autonomous AI workflows',
      projects: ['Documentation System'],
      tags: ['multi-agent', 'ai', 'automation'],
      trending: true,
      color: 'from-violet-500 to-purple-600',
      relatedSkills: ['LangChain', 'OpenAI', 'Python'],
      lastUsed: 'Currently using',
    },
    {
      id: 'huggingface',
      ...
      category: 'AI/ML',
      icon: <Brain className="w-4 h-4" />,
      description: 'Transformers, model hub, fine-tuning, datasets',
      projects: ['AI research'],
      tags: ['transformers', 'models', 'ai'],
      color: 'from-yellow-400 to-orange-500',
      relatedSkills: ['PyTorch', 'Fine-tuning', 'NLP'],
      lastUsed: '2024',
    },
    {
      id: 'local-llms',
      ...
      description: 'Privacy-first AI with Llama, Mistral, Phi models',
      projects: ['Enterprise Platform', 'Voice'],
      tags: ['local-llm', 'privacy-first', 'ollama'],
      trending: true,
      color: 'from-green-500 to-emerald-600',
      relatedSkills: ['Ollama', 'Python', 'MCP'],
      lastUsed: 'Currently using',
    },
    {
      id: 'fine-tuning',
      ...
      description: 'LoRA, QLoRA, PEFT, dataset preparation',
      projects: ['Custom models'],
      tags: ['fine-tuning', 'training', 'ai'],
      color: 'from-red-500 to-pink-600',
      relatedSkills: ['Hugging Face', 'PyTorch', 'Local LLMs'],
      lastUsed: '2024',
    },
    {
      ...
      category: 'AI/ML',
      icon: <Layers className="w-4 h-4" />,
      description: 'Context windows, memory systems, conversation management',
      projects: ['All AI projects'],
      tags: ['context-engineering', 'memory', 'ai'],
      trending: true,
      color: 'from-blue-500 to-indigo-600',
      relatedSkills: ['RAG', 'MCP', 'Prompt Engineering'],
      lastUsed: 'Currently using',
    },
    {
      id: 'ai-basics',
      ...
      description: 'Neural networks, transformers, attention mechanisms, tokenization',
      projects: ['All AI projects'],
      tags: ['ai-basics', 'fundamentals', 'theory'],
      color: 'from-gray-500 to-gray-700',
      relatedSkills: ['Deep Learning', 'NLP', 'Machine Learning'],
      lastUsed: 'Currently using',
    },
    ...
    // AI/ML heuristics and pipeline skills (AI Assistant)
    {
      ...
      projects: ['AI Assistant', 'Scraper', 'QuizMentor'],
    ...
    },
    {
      ...
      projects: ['AI Assistant', 'QuizMentor'],
    ...
    // System Design & Architecture
    {
      ...
      icon: <Network className="w-4 h-4" />,
      description: 'Distributed systems, microservices, scalability patterns, high availability',
      highlights: [
      ...
      projects: ['Enterprise systems', 'Enterprise Platform', 'QuizMentor'],
    ...
    },
    {
      ...
      category: 'Architecture',
      icon: <Boxes className="w-4 h-4" />,
      description: 'Clean architecture, DDD, hexagonal architecture, design patterns',
      highlights: [
      ...
      projects: ['Enterprise Platform', 'Enterprise systems'],
      tags: ['architecture', 'ddd', 'patterns'],
      trending: true,
      color: 'from-blue-600 to-cyan-600',
      relatedSkills: ['System Design', 'Microservices', 'TypeScript'],
      lastUsed: 'Currently using',
    },
    {
      id: 'cli-development',
      ...
      category: 'Architecture',
      icon: <Terminal className="w-4 h-4" />,
      description: 'Command-line tools, automation scripts, developer tooling',
      highlights: [
      ...
      projects: ['Developer Toolkit', 'GenericMCP', 'Repoman'],
      tags: ['cli', 'automation', 'developer-tools'],
      trending: true,
      color: 'from-green-600 to-emerald-600',
      relatedSkills: ['Python', 'Node.js', 'Bash'],
      lastUsed: 'Currently using',
    },
    {
      ...
      category: 'Architecture',
      icon: <Workflow className="w-4 h-4" />,
      description: 'Full-stack architecture, data flow design, integration patterns',
      highlights: [
      ...
      projects: ['QuizMentor', 'Enterprise Platform', 'Enterprise systems'],
      tags: ['e2e', 'fullstack', 'integration'],
      color: 'from-violet-600 to-purple-600',
      relatedSkills: ['System Design', 'API Design', 'DevOps'],
      lastUsed: 'Currently using',
    },
    {
      ...
      category: 'Architecture',
      icon: <Shield className="w-4 h-4" />,
      description: 'SOLID, DRY, KISS, YAGNI, separation of concerns, fault tolerance',
      highlights: [
      ...
      tags: ['principles', 'patterns', 'best-practices'],
      color: 'from-orange-600 to-red-600',
      relatedSkills: ['Architecture Design', 'Clean Code', 'Testing'],
      lastUsed: 'Currently using',
    },
    
    // Additional specialized AI/ML and development concepts
    {
      id: 'idempotent',
      name: 'Idempotent Design Patterns',
      category: 'Backend',
      icon: <Shield className="w-4 h-4" />,
      description: 'Ensuring operations produce same result regardless of execution count',
      projects: ['All production APIs'],
      tags: ['idempotent', 'reliability', 'patterns'],
      color: 'from-blue-500 to-indigo-600',
      relatedSkills: ['API Design', 'Database Transactions'],
      lastUsed: 'Currently using',
    },
    {
      id: 'templates',
      name: 'Code Templates & Generators',
      category: 'Backend',
      icon: <FileCode className="w-4 h-4" />,
      description: 'Reusable templates, scaffolding, code generation patterns',
      projects: ['Platform', 'AI-OS'],
      tags: ['templates', 'codegen', 'automation'],
      color: 'from-purple-500 to-pink-600',
      relatedSkills: ['TypeScript', 'Python', 'CLI Tools'],
      lastUsed: 'Currently using',
    },
    {
      id: 'privacy-first',
      ...
      description: 'Zero-knowledge, local processing, data minimization, GDPR compliance',
      projects: ['Enterprise Platform', 'Voice', 'AI Assistant'],
      tags: ['privacy-first', 'security', 'compliance'],
      trending: true,
      color: 'from-green-600 to-emerald-700',
      relatedSkills: ['Local LLMs', 'Encryption', 'GDPR'],
      lastUsed: 'Currently using',
    },
    {
      id: 'educational-content',
      name: 'Educational Content Systems',
      category: 'AI/ML',
      icon: <BookOpen className="w-4 h-4" />,
      description: 'Bloom\'s taxonomy, adaptive learning, pedagogical frameworks',
      projects: ['QuizMentor', 'AI Assistant'],
      tags: ['educational-content', 'learning', 'pedagogy'],
      color: 'from-amber-500 to-orange-600',
      relatedSkills: ['Quiz Generator', 'Content Analysis', 'NLP'],
      lastUsed: 'Currently using',
    },
    {
      id: 'quiz-generator',
      name: 'Intelligent Quiz Generation',
      category: 'AI/ML',
      icon: <Brain className="w-4 h-4" />,
      description: 'MCQ generation, distractor creation, difficulty balancing, quality scoring',
      projects: ['QuizMentor', 'AI Assistant'],
      tags: ['quiz-generator', 'educational-content', 'ai'],
      trending: true,
      color: 'from-violet-500 to-indigo-600',
      relatedSkills: ['NLP', 'OpenAI', 'Educational Content'],
      lastUsed: 'Currently using',
    },
    {
      id: 'python-ecosystem',
      ...
      category: 'Languages',
      icon: <Activity className="w-4 h-4" />,
      description: 'NumPy, Pandas, scikit-learn, matplotlib, Jupyter',
      projects: ['AI Assistant', 'AI research'],
      tags: ['python', 'data-science', 'analytics'],
      color: 'from-blue-500 to-green-600',
      relatedSkills: ['Python', 'Machine Learning', 'Data Analysis'],
      lastUsed: 'Currently using',
    },
    {
      id: 'mcp-server',
      ...
      category: 'AI/ML',
      icon: <Server className="w-4 h-4" />,
      description: 'Building MCP servers for tool integration with Claude and other LLMs',
      projects: ['Documentation System', 'Enterprise Platform'],
      tags: ['mcp-server', 'mcp', 'tools'],
      trending: true,
      color: 'from-cyan-600 to-blue-700',
      relatedSkills: ['MCP', 'TypeScript', 'API Design'],
      lastUsed: 'Currently using',
    },
  ];
  ...
  const categories = [
    ...
    },
    {
      ...
      name: 'Architecture',
      icon: <Boxes className="w-4 h-4" />,
      count: allSkills.filter((s) => s.category === 'Architecture').length,
    },
  ];

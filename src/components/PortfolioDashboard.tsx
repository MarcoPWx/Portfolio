...
const products: Product[] = [
  ...
  },
  {
    ...
    techStack: ['Multiple Languages', 'Cloud Native', 'API First'],
    metrics: {
      users: 'Private Beta',
      rating: 4.8,
  ...
  },
  {
    ...
    url: '#',
    status: 'coming-soon',
    features: ['Team collaboration', 'Enterprise security', 'Scalable architecture', 'Priority support'],
    techStack: ['Cloud Native', 'Enterprise Grade', 'Secure by Design'],
    metrics: {
      users: 'Coming Soon',
      rating: 4.9,
      downloads: 'Join Waitlist',
    },
  },
  {
    id: 'voiceapp',

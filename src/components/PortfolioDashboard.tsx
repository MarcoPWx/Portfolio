...
const products: Product[] = [
  ...
  },
  {
    ...
    description:
      'Community Edition toolkit for AI-assisted development. No cloud dependencies required. Includes Agent Boot CLI, minimal Node toolbelt, and architecture guides for autonomous development.',
    icon: '🛠️',
    gradient: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)',
    url: 'https://github.com/MarcoPWx/AI-OS-CE',
    status: 'live',
    features: [
      'Agent Boot CLI for DEVLOG management',
      'EPIC & task tracking',
      'Security/performance checks',
      'S2S Journey patterns',
    ],
    techStack: ['Python', 'Node.js', 'TypeScript', 'GitHub Actions'],
    metrics: {
      users: '3K+',
      rating: 4.8,
      downloads: '15K+',
  ...
  },
  {
    ...
    description:
      'Professional edition with advanced features for teams. Includes multi-agent orchestration, enterprise security, team collaboration tools, and priority support.',
    icon: '🚀',
    gradient: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)',
    url: 'https://github.com/MarcoPWx/AI-OS-Pro',
    status: 'beta',
    features: ['Multi-agent orchestration', 'Enterprise security', 'Team collaboration', 'Priority support'],
    techStack: ['TypeScript', 'Python', 'Kubernetes', 'Docker'],
    metrics: {
      users: '2K+',
      rating: 4.9,
      downloads: '10K+',
  ...
  },
  {
    id: 'voiceapp',
    name: 'VoiceApp',
    tagline: 'Realtime Voice AI Platform',
    description:
      'Build realtime voice apps with AI-powered patterns. Complete educational platform for voice assistant development with Expo, featuring speech recognition, NLP, dialogue management, and voice biometrics.',
    icon: '🎙️',
    gradient: 'linear-gradient(135deg, #667eea 0%, #00d4ff 100%)',
    url: 'https://github.com/MarcoPWx/VOICEAPP',
    status: 'beta',
    features: [
    ...
    techStack: ['React Native', 'Expo', 'TypeScript', 'VitePress', 'WebRTC'],
    metrics: {
      users: '1K+',
      rating: 4.7,
      downloads: '5K+',

...
export function ProfessionalPortfolio() {
  ...
  const products = {
    quizmentor: {
      ...
      description:
        'A sophisticated mobile learning platform that leverages psychological engagement patterns and gamification to achieve industry-leading retention rates. Built for scale with 10,000+ questions across 72 categories.',
      status: 'Production',
      icon: Gamepad2,
    ...
    omni: {
      ...
      description:
        'Next-generation VS Code extension that unifies all major AI providers with intelligent routing, cost optimization, and seamless provider switching.',
      status: 'Coming Soon',
      icon: Bot,
  ...
  const currentProduct = (products as any)[activeProduct];
        ...
        <section className="pt-32 pb-20 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <MetricCard icon={Users} value="20K+" label="Active Developers" trend="+150% YoY" />
              <MetricCard icon={Code2} value="5M+" label="API Calls Daily" trend="+200% QoQ" />
              <MetricCard icon={Rocket} value="99.9%" label="Uptime SLA" />
              <MetricCard icon={Star} value="4.9" label="User Rating" />
            </div>
          </div>
        </section>
      )}
        ...
        <section className="pt-32 pb-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">Our Product Suite</h2>
            ...
            >
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center mb-6">
                  <div
                    className={`w-20 h-20 bg-gradient-to-br ${currentProduct.gradient} rounded-2xl flex items-center justify-center`}
                  >
              ...
              <div className="max-w-5xl mx-auto">
                  ...
                  <div className="space-y-8">
                    <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8">
                      ...
                      <ul className="space-y-4">
                        {currentProduct.highlights.map((highlight: string, idx: number) => (
                ...
                {activeTab === 'features' && (
                  <div className="grid md:grid-cols-2 gap-6">
                    {currentProduct.features.map((feature: any, idx: number) => (
                      <div
                        key={idx}
                ...
                {activeTab === 'technology' && (
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {(Object.entries(currentProduct.tech) as [string, string[]][]).map(
                      ([category, techs]) => (
                        <div
                          key={category}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8">
                ...
                <p className="text-gray-400 mb-4">Enterprise-grade backend built for scale</p>
                <ul className="space-y-2 text-sm text-gray-300">
              ...
              <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8">
                ...
                <p className="text-gray-400 mb-4">Modern, responsive interfaces across platforms</p>
                <ul className="space-y-2 text-sm text-gray-300">
